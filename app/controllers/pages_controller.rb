class PagesController < ApplicationController
  def index
    ...
    @documents = PgSearch::Document.featured.includes(:searchable).map(&:searchable).compact # we do not have FK constraints here, compact eliminates any possible documents hanging without searchable counterpart, which was deleted
  end
