  ...
  module OrSrApp
    module StakeholdersIdentifiers
      class ApplicationForm
        ...
        def initialize(json_form_data: nil, form_data: nil, current_stakeholder_index: -1, submit_action: 'save', go_to_summary: false, back: false)
          if json_form_data
        ...
        def should_go_to_summary?
          (@submit_action == 'save' && @go_to_summary == 'true') || (@current_stakeholder_index == @form_data&.stakeholders_with_missing_identifiers&.size - 1)
        end
